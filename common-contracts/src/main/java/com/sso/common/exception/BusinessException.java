 ...
 *
 * <p>Exception này đóng gói một {@link ErrorCode} để các tầng xử lý lỗi
 * (GlobalExceptionHandler) có thể tự động ánh xạ lỗi nghiệp vụ ra mã phản hồi HTTP
 * và cấu trúc JSON đồng bộ.
 *
