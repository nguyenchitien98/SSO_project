 ...
 *
 * <p>Kiểm tra tính đúng đắn của việc nạp thông tin user từ repository và chuyển đổi các quyền hạn
 * (Roles/Permissions) thành GrantedAuthority trong Spring Security.
 *
...
class CustomUserDetailsServiceTest {
  ...
  void loadUserByUsername_Success() {
    ...
    Permission readPermission =
        Permission.builder().name("PRODUCT_READ").resource("PRODUCT").action("READ").build();
