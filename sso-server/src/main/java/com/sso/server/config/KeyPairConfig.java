 ...
 *
 * <p>Sinh cặp khóa RSA 2048-bit động khi ứng dụng khởi động. Khóa Private được dùng để ký
 * chữ ký số cho các token JWT (Access Token, ID Token) do Authorization Server phát hành.
 * Khóa Public được công bố công khai qua JWKS endpoint (/oauth2/jwks) để các Client và
 * Gateway tải về thực hiện kiểm chứng chữ ký của token một cách ngoại tuyến (offline validation).
 *
