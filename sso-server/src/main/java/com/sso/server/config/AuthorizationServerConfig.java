 ...
 *
 * <p>Định nghĩa chuỗi bộ lọc bảo mật có độ ưu tiên cao nhất (Order(Ordered.HIGHEST_PRECEDENCE)) để
 * xử lý tất cả các endpoint giao thức OAuth2 chuẩn hóa bao gồm:
 *
 * <ul>
 *   <li>Authorization Endpoint (`/oauth2/authorize`)
 *   <li>Token Endpoint (`/oauth2/token`)
 *   <li>Token Revocation Endpoint (`/oauth2/revoke`)
 *   <li>JWKS Endpoint (`/oauth2/jwks`)
 *   <li>OIDC Provider Configuration Metadata Endpoint (`/.well-known/openid-configuration`)
 * </ul>
 *
